...
CATEGORIES = {
    ...
    "5": {"id": "5", "title": "FTP Brute-Force", "description": "No description available. Category is DEPRECATED"},
    "6": {"id": "6", "title": "Ping of Death", "description": "No description available. Category is DEPRECATED"},
    "7": {"id": "7", "title": "Phishing", "description": "No description available. Category is DEPRECATED"},
    ...
    "11": {
        ...
        "title": "Email Spam",
        "description": (
            "Spam email content, infected attachments, phishing emails, and spoofed senders "
    ...
    "15": {"id": "15", "title": "Hacking", "description": "No description available. Category is DEPRECATED"},
    "18": {
        "id": "18",
        "title": "Brute-Force",
    ...
    "21": {
        ...
        "description": (
            "Attempts to probe for or exploit installed web applications such as a CMS like "
